...
def create_relative_encoding(
  ...
  size = seq_features.seq_length
  #print(size)
  #offset = offset.at[:size, :size].set(seq_features.cyc_matrix)
  offset = jax.lax.dynamic_update_slice(offset, seq_features.cyc_matrix_residue, (0, 0))
  ...
  # start of add on 20241126
  #token_offset = token_offset.at[:size, :size].set(seq_features.cyc_matrix)
  token_offset = jax.lax.dynamic_update_slice(token_offset, seq_features.cyc_matrix_token, (0, 0))
  # end of add on 20241126
