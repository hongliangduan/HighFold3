...
def create_relative_encoding(
  ...
  offset = jax.lax.dynamic_update_slice(offset, seq_features.cyc_matrix, (0, 0))
  ...
  token_offset = jax.lax.dynamic_update_slice(token_offset, seq_features.cyc_matrix, (0, 0))
  # end of add on 20241126
